...
static int rx_copybreak = ETH_ZLEN;
...
static int proc_get_driver_variable(struct seq_file *m, void *v)
{
        ...
        seq_printf(m, "timer_count_v2\t0x%x\n", timer_count_v2);
        seq_printf(m, "INT_MITI_V2_0_RX\t0x%x\n", RTL_R8(tp, INT_MITI_V2_0_RX));
        seq_printf(m, "INT_MITI_V2_0_TX\t0x%x\n", RTL_R8(tp, INT_MITI_V2_0_TX));
                              ...
                              u8 timer_intmiti_val)
{
        ...
        case 4:
                ...
                if (message_id == 0) //ROK
                        RTL_W8(tp,INT_MITI_V2_0_RX, timer_intmiti_val);
...
#ifndef ETHTOOL_LEGACY_2500baseX
...
rtl8125_hw_config(struct net_device *dev)
{
        ...
        if (tp->use_timer_interrrupt &&
            ...
            (tp->features & RTL_FEATURE_MSIX)) {
                RTL_W8(tp, INT_MITI_V2_0_TX, timer_count_v2);
                RTL_W8(tp, INT_MITI_V2_1_TX, timer_count_v2);
        }
